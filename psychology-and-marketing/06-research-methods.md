...
### Sin investigación:
```
❌ Diseñas lo que CREES que quieren (y a menudo te equivocas)
...
Cambios de UI:
5 usuarios ≈ 85% de los problemas de usabilidad
(Nielsen y Landauer, 1993: con una tasa media de
detección del 31% por usuario, 1 − 0,69⁵ ≈ 0,84)
```
